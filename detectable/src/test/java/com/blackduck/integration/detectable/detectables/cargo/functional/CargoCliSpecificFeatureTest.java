...
/**
 * Test case: detect.cargo.included.features=gzip
 * Expected: Default features + gzip feature dependencies in BOM.
 */
public class CargoCliSpecificFeatureTest extends DetectableFunctionalTest {

    public CargoCliSpecificFeatureTest() throws IOException {
        super("cargo-specific-feature");
    }
    ...
    protected void setup() throws IOException {
        ...
        ExecutableOutput specificOutput = createStandardOutput(
        ...
        addExecutableOutput(specificOutput, "cargo", "tree", "--prefix", "depth", "--workspace", "--features", "gzip");
    }
