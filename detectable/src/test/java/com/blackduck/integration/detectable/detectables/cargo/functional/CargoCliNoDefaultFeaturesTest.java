...
/**
 * Test case: detect.cargo.disable.default.features=true
 * Expected: Only non-optional dependencies in BOM (no default features).
 */
public class CargoCliNoDefaultFeaturesTest extends DetectableFunctionalTest {

    public CargoCliNoDefaultFeaturesTest() throws IOException {
        super("cargo-no-default-features");
    }
    ...
    protected void setup() throws IOException {
        ...
        ExecutableOutput noDefaultOutput = createStandardOutput(
        ...
        addExecutableOutput(noDefaultOutput, "cargo", "tree", "--prefix", "depth", "--workspace", "--no-default-features");
    }
