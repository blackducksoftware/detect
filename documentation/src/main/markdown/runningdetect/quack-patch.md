...
* (Optional) Set the `detect.quack.patch.output` property to specify a custom directory for generated patches. The default is the `quack-patch` folder located within the scan output directory.
