...
* **Deprecation of Java 11 support** - In alignment with EU Cyber Resilience Act (CRA) requirements and compliance timelines, Java 11 support will be deprecated in the [detect_product_short] 13.0.0 release.
