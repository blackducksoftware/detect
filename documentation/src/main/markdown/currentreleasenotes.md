...
* **Deprecation of support for Java versions earlier than 17 - Support for Java versions earlier than 17 will be deprecated in [detect_product_short] 13.0.0 to align with EU Cyber Resilience Act (CRA) requirements and compliance timelines.
