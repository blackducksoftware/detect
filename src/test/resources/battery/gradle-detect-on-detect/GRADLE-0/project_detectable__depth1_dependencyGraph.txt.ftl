...
+--- com.blackduck.integration:integration-rest (n)
+--- org.tomlj:tomlj:1.1.0 (n)
+--- com.moandjiezana.toml:toml4j:0.7.2 (n)
+--- com.paypal.digraph:digraph-parser:1.0 (n)
\--- guru.nidi:graphviz-java:0.18.1 (n)
